...
function displayPics(){
  ...
  // DONE: In a sentence or two, explain why the previous line of code threw an error when we changed the variable declaration from `let to `let`.
  // PUT YOUR RESPONSE IN THIS COMMENT: This is due to the fact that let limits the variable to only be used within the block it was defined in or it's sub blocks. The console log was outside the block it was defined in. 
  console.log(viewed)
